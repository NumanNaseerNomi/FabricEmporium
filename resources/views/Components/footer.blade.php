...
<div class="container-fluid bg-clr">
	<div class="container pt-4 pb-4">
		...
		<div class="footer-logo"><a href=""><img class="logo" src="{{ asset('images/logos/footerLogo.png')}}"></a></div>
	...
	<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
			<div class="Social-links d-flex">
				<a class="links" href=""><i class="fs-4 text-white link fab fa-instagram"></i></a>
				<a class="links" href=""><i class="fs-4 text-white link fab fa-facebook-f"></i></a>
				<a class="links" href=""><i class="fs-4 text-white link fab fa-whatsapp"></i></a>
			</div>
